...
export function BlogPage() {
  return (
    <div className="pt-32 pb-20 bg-warm-gradient min-h-screen">
      <Helmet>
        <title>Kennisbank & Tips | Parkstad Thuiszorg</title>
        <meta name="description" content="Handige artikelen over thuiszorg, mantelzorg, PGB, dementie en revalidatie. Kennisbank van Parkstad Thuiszorg." />
      </Helmet>
        ...
        <AnimatedSection delay={0.5} className="text-center mt-16">
          <div className="bg-[#064a54] dark:bg-[#1e2e25] p-8 md:p-12 rounded-3xl text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Link to="/contact" className="inline-flex items-center gap-2 bg-[#4A9C6E] hover:bg-[#3b7c58] text-white px-8 py-3 rounded-full font-medium transition-colors">
