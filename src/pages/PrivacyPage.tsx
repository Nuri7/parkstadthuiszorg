...
export function PrivacyPage() {
  return (
    <div className="pt-32 pb-20 bg-warm-gradient min-h-screen">
      <Helmet>
        <title>Privacybeleid | Parkstad Thuiszorg</title>
        <meta name="description" content="Lees hoe Parkstad Thuiszorg omgaat met uw persoonsgegevens. Wij beschermen uw privacy conform de AVG." />
      </Helmet>
          ...
          <AnimatedSection delay={0.1}>
            <div className="bg-white dark:bg-[#243029] p-8 rounded-3xl shadow-md border border-[#ede7db] dark:border-[#086370]">
              ...
              <p className="text-[#4f6b6f] dark:text-[#5cb0bd] leading-relaxed">
                Parkstad Thuiszorg, gevestigd te Kerkrade, is verantwoordelijk voor de verwerking van persoonsgegevens zoals weergegeven in dit privacybeleid. Wij verwerken uw gegevens in overeenstemming met de Algemene Verordening Gegevensbescherming (AVG).
              </p>
            </div>
          </AnimatedSection>
