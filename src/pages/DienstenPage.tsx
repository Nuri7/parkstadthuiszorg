...
export function DienstenPage() {
  return (
    <div className="pt-32 pb-20 bg-warm-gradient min-h-screen">
      <Helmet>
        <title>Onze Zorgvormen & Diensten | Parkstad Thuiszorg</title>
        <meta name="description" content="Bekijk ons zorgaanbod: van wijkverpleging en persoonlijke verzorging tot palliatieve zorg en nachtzorg in Landgraaf, Heerlen en Kerkrade." />
      </Helmet>
