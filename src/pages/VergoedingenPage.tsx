...
export function VergoedingenPage() {
  return (
    <div className="pt-32 pb-20 bg-[#fdfbf7] dark:bg-[#1a2420] min-h-screen">
      <Helmet>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 mb-16">
          ...
          <AnimatedSection delay={0.1}>
            <div className="bg-white dark:bg-[#243029] p-8 rounded-3xl shadow-md border-l-4 border-l-[#5b7f63] border-t border-b border-r border-[#ede7db] dark:border-[#344a3c]">
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-[#e8f0e9] dark:bg-[#1e2e25] rounded-xl text-[#5b7f63]">
                  <Heart className="w-6 h-6" />
                </div>
                <h3 className="text-2xl font-heading text-[#2d3b2d] dark:text-[#fdfbf7]">Zorgverzekeringswet (Zvw)</h3>
              </div>
              <p className="text-[#6B7B6B] dark:text-[#94ba9a] mb-4 leading-relaxed">
                Valt uw zorgvraag onder persoonlijke verzorging of wijkverpleging? Dan wordt dit bekostigd vanuit uw basisverzekering (Zvw).
              </p>
              <ul className="list-disc pl-5 text-[#6B7B6B] dark:text-[#dce8de] space-y-2 mb-4">
                <li><strong className="text-[#2d3b2d] dark:text-white">Geen eigen risico:</strong> Wijkverpleging gaat niet ten koste van uw eigen risico.</li>
                <li><strong className="text-[#2d3b2d] dark:text-white">Geen eigen bijdrage:</strong> U betaalt geen inkomensafhankelijke eigen bijdrage (CAK).</li>
                <li><strong className="text-[#2d3b2d] dark:text-white">Indicatie:</strong> Hiervoor is een indicatie nodig van een (onze) wijkverpleegkundige.</li>
              </ul>
              <div className="bg-[#f0f5f1] dark:bg-[#1e2e25] p-4 rounded-xl text-sm text-[#5b7f63] dark:text-[#94ba9a]">
          ...
          <AnimatedSection delay={0.2}>
            <div className="bg-white dark:bg-[#243029] p-8 rounded-3xl shadow-md border-l-4 border-l-[#C67D5B] border-t border-b border-r border-[#ede7db] dark:border-[#344a3c]">
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-[#fdf4ef] dark:bg-[#3f1f14] rounded-xl text-[#C67D5B]">
                  <Building2 className="w-6 h-6" />
                </div>
                <h3 className="text-2xl font-heading text-[#2d3b2d] dark:text-[#fdfbf7]">Wet Maatschappelijke Ondersteuning (Wmo)</h3>
              </div>
              <p className="text-[#6B7B6B] dark:text-[#94ba9a] mb-4 leading-relaxed">
              ...
              <ul className="list-disc pl-5 text-[#6B7B6B] dark:text-[#dce8de] space-y-2 mb-4">
                <li><strong className="text-[#2d3b2d] dark:text-white">Eigen bijdrage:</strong> Ja, er geldt een (vast) abonnementstarief via het CAK (max €20,60 per maand in 2024).</li>
                <li><strong className="text-[#2d3b2d] dark:text-white">Aanvraag:</strong> Via het Wmo-loket van uw gemeente.</li>
              </ul>
            </div>
          </AnimatedSection>

          <AnimatedSection delay={0.3}>
            <div className="bg-white dark:bg-[#243029] p-8 rounded-3xl shadow-md border-l-4 border-l-[#476550] border-t border-b border-r border-[#ede7db] dark:border-[#344a3c]">
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-[#e8f0e9] dark:bg-[#1e2e25] rounded-xl text-[#476550]">
                  <FileText className="w-6 h-6" />
                </div>
                <h3 className="text-2xl font-heading text-[#2d3b2d] dark:text-[#fdfbf7]">Wet Langdurige Zorg (Wlz)</h3>
              </div>
              <p className="text-[#6B7B6B] dark:text-[#94ba9a] mb-4 leading-relaxed">
          ...
          <AnimatedSection delay={0.4}>
            <div className="bg-[#2d3b2d] dark:bg-[#1e2e25] p-8 md:p-10 rounded-3xl shadow-xl text-white relative overflow-hidden">
               {/* Pattern overlay */}
               ...
               <div className="relative z-10">
                 ...
                 <p className="mb-6 text-[#94ba9a] text-lg leading-relaxed">
                 ...
                 <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                    ...
                    <Button asChild variant="primary" className="bg-[#C67D5B] hover:bg-[#b8623e] border-none">
