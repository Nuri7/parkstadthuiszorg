    ...
    <section id="hoe-werkt-het" className="section-padding bg-[var(--color-beige-200)] relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-heading text-[var(--color-sage-800)] mb-6">
            Zorg regelen in 4 stappen
          </h2>
          <p className="text-lg text-[var(--color-sage-600)] max-w-2xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="absolute left-[27px] md:left-1/2 top-0 bottom-0 w-1 bg-[var(--color-beige-300)] -translate-x-1/2 rounded-full" />
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-0 md:left-1/2 -ml-2 md:-ml-0 -translate-x-0 md:-translate-x-1/2 flex items-center justify-center">
                    <div className="w-14 h-14 rounded-full bg-[var(--color-terra-400)] border-4 border-[var(--color-beige-200)] flex items-center justify-center shadow-lg relative z-10 text-white">
                      <Icon className="w-6 h-6" />
                    </div>
                  </div>
                  
                  <div className={`w-full md:w-1/2 pl-16 md:pl-12 pr-0 md:px-12 py-2 text-left ${index % 2 === 0 ? 'md:text-left' : 'md:text-right'}`}>
                    <h3 className="text-2xl font-bold text-[var(--color-sage-800)] mb-2">
                      {step.title}
                    </h3>
                    <p className="text-[var(--color-sage-600)]">
                      {step.description}
                    </p>
                  </div>
                </motion.div>
